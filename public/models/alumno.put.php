...
if($_SERVER['REQUEST_METHOD']==='PUT'){
	if(sessionStatus()){
		...
		$affect    = $db->exec("update alumno set t_docume='$t_docume', e_numero='$e_numero', c_codigo='$c_codigo', a_nombre='$a_nombre', a_nacion='$a_nacion', a_nacimi='$a_nacimi', a_cuil='$a_cuil', a_domici='$a_domici', a_barrio='$a_barrio', a_correo='$a_correo', a_idioma='$a_idioma', a_telefo='$a_telefo', a_condic='$a_condic', a_faltas='$a_faltas', a_promed='$a_promed', a_celula='$a_celula', a_fechai='$a_fechai', a_fechaf='$a_fechaf', a_titulo='$a_titulo', a_copdni='$a_copdni', a_copnac='$a_copnac', a_coppri='$a_coppri', a_copbol='$a_copbol', a_copecg='$a_copecg', a_copsal='$a_copsal', a_copmed='$a_copmed', a_copcuil='$a_copcuil', a_fotoca='$a_fotoca', a_egreso='$a_egreso', a_conreg='$a_conreg', a_conapr='$a_conapr', a_croqui='$a_croqui' where a_docume='$a_docume';");
