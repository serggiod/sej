...
if($_SERVER['REQUEST_METHOD']==='POST'){
	if(sessionStatus()){
		...
		$affect    = $db->exec("insert into docente values('$d_docume','$d_nombre','$d_domici','$d_telefo','$d_barrio','$d_cuil','$d_nacion','$d_nacimi','$d_celula','$d_titulo','$u_codigo','$d_ecivil','$d_decjur','$d_copnac','$d_copdni','$d_coppla','$d_copleg','$d_copper','$d_copdap','$d_copcse','$d_copcui','$d_copsou','$d_croqui');");
