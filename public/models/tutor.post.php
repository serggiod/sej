...
if($_SERVER['REQUEST_METHOD']==='POST'){
	if(sessionStatus()){
		...
		$affect    = $db->exec("insert into tutor values('$t_docume','$t_nombre','$t_domici','$t_telefo','$u_codigo','$t_barrio','$t_cuil','$t_nacion','$t_nacimi','$t_celula','$t_telalt','$t_ocupac','$t_dirtra','$t_teltra','$t_croqui');");
